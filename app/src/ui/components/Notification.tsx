...
import { CheckCircle, AlertCircle, Info, X } from "lucide";
...
export const Notification = ({
  ...
  let containerClasses = "pointer-events-auto flex items-center gap-3 p-4 border-[3px] border-[#2D2A26] shadow-[4px_4px_0px_#2D2A26] rounded-none mb-4 relative transition-all duration-200";
  let iconNode = Info;
