var htmx = function () {
  ...
  function d(e) {
    ...
    else if (e.slice(-1) == 'm') t = parseFloat(e.slice(0, -1)) * 1e3 * 60;
    else t = parseFloat(e);
  ...
  function i(e, t, n) {
    ...
    if (e !== t) {
      if (Q.config.disableInheritance) {
        if (i && (i === '*' || i.split(' ').indexOf(n) >= 0)) return r;
        else return null;
      }
  ...
  function h(e, t) {
    const n = e instanceof Element &&
      (e.matches || e.matchesSelector || e.msMatchesSelector || e.mozMatchesSelector ||
        e.webkitMatchesSelector || e.oMatchesSelector);
    return !!n && n.call(e, t);
  }
  function T(e) {
    const t = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i;
  ...
  function L(e, t) {
    while (t.childNodes.length > 0) e.append(t.childNodes[0]);
  }
  function A(e) {
  ...
  function P(e) {
    ...
    if (r) {
      if (Q.config.allowScriptTags) I(r);
      else r.querySelectorAll('script').forEach((e) => e.remove());
    }
    return r;
  }
  function oe(e) {
  ...
  function ce(e, t) {
    for (const n in t) if (t.hasOwnProperty(n)) e[n] = t[n];
    return e;
  }
  function S(e) {
    try {
  ...
  function u(e, t) {
    if (typeof e !== 'string') return e.querySelector(t);
    else return u(ne(), e);
  }
  function x(e, t) {
    if (typeof e !== 'string') return e.querySelectorAll(t);
    else return x(ne(), e);
  }
  function E() {
    return window;
  ...
  function G(e, t, n) {
    ...
    if (n) {
      E().setTimeout(function () {
        ...
        if (r.classList.length === 0) r.removeAttribute('class');
      }}
  }
  function W(e, t) {
    e = y(e);
  ...
  function ge(e) {
    const t = e.trim();
    if (l(t, '<') && Y(t, '/>')) return t.substring(1, t.length - 2);
    else return t;
  }
  function p(t, r, n) {
    if (r.indexOf('global ') === 0) return p(t, r.slice(7), true);
    t = y(t);
    const o = [];
    {
      let t = 0;
      ...
      for (let e = 0; e < r.length; e++) {
        ...
        if (l === '<') t++;
        else if (l === '/' && e < r.length - 1 && r[e + 1] === '>') t--;
      }
    ...
    while (o.length > 0) {
      const r = ge(o.shift());
      let e;
      if (r.indexOf('closest ') === 0) e = g(ue(t), ge(r.substr(8)));
      else if (r.indexOf('find ') === 0) e = u(f(t), ge(r.substr(5)));
      else if (r === 'next' || r === 'nextElementSibling') e = ue(t).nextElementSibling;
      else if (r.indexOf('next ') === 0) e = pe(t, ge(r.substr(5)), !!n);
      else if (r === 'previous' || r === 'previousElementSibling') e = ue(t).previousElementSibling;
      else if (r.indexOf('previous ') === 0) e = me(t, ge(r.substr(9)), !!n);
      else if (r === 'document') e = document;
      else if (r === 'window') e = window;
      else if (r === 'body') e = document.body;
      else if (r === 'root') e = m(t, !!n);
      else if (r === 'host') e = t.getRootNode().host;
      else s.push(r);
      if (e) i.push(e);
    }
    if (s.length > 0) {
  ...
  var pe = function (t, e, n) {
    ...
    for (let e = 0; e < r.length; e++) {
      const o = r[e];
      if (o.compareDocumentPosition(t) === Node.DOCUMENT_POSITION_PRECEDING) return o;
    }
  };
  var me = function (t, e, n) {
    ...
    for (let e = r.length - 1; e >= 0; e--) {
      const o = r[e];
      if (o.compareDocumentPosition(t) === Node.DOCUMENT_POSITION_FOLLOWING) return o;
    }
  };
  function ae(e, t) {
    if (typeof e !== 'string') return p(e, t)[0];
    else return p(ne().body, e)[0];
  }
  function y(e, t) {
    if (typeof e === 'string') return u(f(t) || document, e);
    else return e;
  }
  function xe(e, t, n, r) {
    if (k(t)) return { target: ne().body, event: J(e), listener: t, options: n };
    else return { target: y(e), event: J(t), listener: n, options: r };
  }
  function ye(t, n, r, o) {
    Vn(function () {
      const e = xe(t, n, r, o);
  ...
  function Ee(e) {
    ...
    if (t) {
      if (t === 'this') return Se(e, 'hx-target');
      else return ae(e, t);
    } else {
      const n = ie(e);
      if (n.boosted) return ne().body;
      else return e;
    }
  }
  function Ce(t) {
    const n = Q.config.attributesToSettle;
    for (let e = 0; e < n.length; e++) if (t === n[e]) return true;
    return false;
  }
  function Oe(t, n) {
    se(t.attributes, function (e) {
      if (!n.hasAttribute(e.name) && Ce(e.name)) t.removeAttribute(e.name);
    });
    se(n.attributes, function (e) {
      if (Ce(e.name)) t.setAttribute(e.name, e.value);
    });
  }
  function Re(t, e) {
    const n = Un(e);
    for (let e = 0; e < n.length; e++) {
      const r = n[e];
      try {
        if (r.isInlineSwap(t)) return true;
      } catch (e) {
        O(e);
      }
    }
  ...
  function a(e, t, n, r) {
    ...
    while (n.childNodes.length > 0) {
      ...
      e.insertBefore(o, t);
      if (o.nodeType !== Node.TEXT_NODE && o.nodeType !== Node.COMMENT_NODE) r.tasks.push(Ae(o));
    }
  }
  function Ie(e, t) {
    let n = 0;
    while (n < e.length) t = (t << 5) - t + e.charCodeAt(n++) | 0;
    return t;
  }
  function Pe(t) {
    let n = 0;
  ...
  function De(e) {
    ...
    if (t.listenerInfos) {
      se(t.listenerInfos, function (e) {
        if (e.on) be(e.on, e.trigger, e.listener);
      });
    }
    ke(e);
  ...
  function Me(t, e, n) {
    if (t instanceof Element && t.tagName === 'BODY') return Ve(t, e, n);
    let r;
    const o = t.previousSibling;
    const i = c(t);
    if (!i) return;
    a(i, t, e, n);
    if (o == null) r = i.firstChild;
    else r = o.nextSibling;
    n.elts = n.elts.filter(function (e) {
      return e !== t;
    });
    while (r && r !== t) {
      if (r instanceof Element) n.elts.push(r);
      r = r.nextSibling;
    }
    b(t);
  ...
  function _e(t, e, n, r, o) {
    switch (t) {
      ...
      default:
        ...
        if (t === 'innerHTML') Ve(n, r, o);
        else _e(Q.config.defaultSwapStyle, e, n, r, o);
    }
  }
  function ze(e, n, r) {
  ...
  function $e(e, t, r, o) {
    ...
    const l = xn(e);
    if (r.swapStyle === 'textContent') e.textContent = t;
    else {
      let n = P(t);
      l.title = n.title;
      if (o.selectOOB) {
      ...
      se(x(n, 'template'), function (e) {
        if (e.content && ze(e.content, l, i)) e.remove();
      });
      if (o.select) {
    ...
    if (o.afterSwapCallback) o.afterSwapCallback();
    ...
    const c = function () {
      ...
      yn(l.elts, r);
      if (o.afterSettleCallback) o.afterSettleCallback();
    };
    if (r.settleDelay > 0) E().setTimeout(c, r.settleDelay);
    else c();
  }
  function Je(e, t, n) {
    ...
    if (r.indexOf('{') === 0) {
      ...
      for (const i in o) {
        if (o.hasOwnProperty(i)) {
          let e = o[i];
          if (D(e)) n = e.target !== undefined ? e.target : n;
          else e = { value: e };
          he(n, i, e);
        }
      }
      ...
      const s = r.split(',');
      for (let e = 0; e < s.length; e++) he(n, s[e].trim(), []);
    }
  }
  const Ke = /\s/;
  const v = /[\s,]/;
  ...
  function tt(e, t, n) {
    return Ge.exec(e.charAt(0)) && e !== 'true' && e !== 'false' && e !== 'this' && e !== n &&
      t !== '.';
  }
  function nt(r, o, i) {
    if (o[0] === '[') {
  ...
  function C(e, t) {
    let n = '';
    while (e.length > 0 && !t.test(e[0])) n += e.shift();
    return n;
  }
  function rt(e) {
    let t;
    ...
    do {
      ...
      if (c !== '') {
        if (c === 'every') {
          ...
          C(o, w);
          var i = nt(e, o, 'event');
          if (i) u.eventFilter = i;
          r.push(u);
        } else {
          const a = { trigger: c };
          var i = nt(e, o, 'event');
          if (i) a.eventFilter = i;
          C(o, w);
          while (o.length > 0 && o[0] !== ',') {
            const f = o.shift();
            if (f === 'changed') a.changed = true;
            else if (f === 'once') a.once = true;
            else if (f === 'consume') a.consume = true;
            else if (f === 'delay' && o[0] === ':') {
              o.shift();
              a.delay = d(C(o, v));
            } else if (f === 'from' && o[0] === ':') {
              ...
              o.shift();
              a[f] = C(o, v);
            } else fe(e, 'htmx:syntax:error', { token: o.shift() });
            C(o, w);
          }
          r.push(a);
        }
  ...
  function st(e) {
    ...
    else if (h(e, 'form')) return [{ trigger: 'submit' }];
    else if (h(e, 'input[type="button"], input[type="submit"]')) return [{ trigger: 'click' }];
    else if (h(e, ot)) return [{ trigger: 'change' }];
  ...
  function ct(e, t, n) {
    ...
    r.timeout = E().setTimeout(function () {
      if (le(e) && r.cancelled !== true) {
        if (!gt(n, e, Mt('hx:poll:trigger', { triggerSpec: n, target: e }))) t(e);
        ct(e, t, n);
      }
    }, n.pollInterval);
  }
  ...
  function ft(t, n, e) {
    if (
      ...
      if (t.tagName === 'A') {
        ...
        o = ee(t, 'action');
        if (o == null || o === '') o = ne().location.href;
  ...
  function dt(e, t) {
    return ie(e).boosted && e instanceof HTMLAnchorElement && t.type === 'click' &&
      (t.ctrlKey || t.metaKey);
  }
  function gt(e, t, n) {
  ...
  function pt(l, c, e, u, a) {
    const f = ie(l);
    let t;
    if (u.from) t = p(l, u.from);
    else t = [l];
    if (u.changed) {
      if (!('lastValue' in f)) f.lastValue = new WeakMap();
      t.forEach(function (e) {
        if (!f.lastValue.has(u)) f.lastValue.set(u, new WeakMap());
    ...
    se(t, function (i) {
      const s = function (e) {
        ...
        if (t.handledFor.indexOf(l) < 0) {
          t.handledFor.push(l);
          if (u.consume) e.stopPropagation();
          if (u.target && e.target) { if (!h(ue(e.target), u.target)) return; }
          if (u.once) {
            if (f.triggeredOnce) return;
            else f.triggeredOnce = true;
          }
          if (u.changed) {
            const n = event.target;
            const r = n.value;
            const o = f.lastValue.get(u);
            if (o.has(n) && o.get(n) === r) return;
            o.set(n, r);
          }
  ...
  function bt(e) {
    if (!s(e, 'data-hx-revealed') && X(e)) {
      ...
      const t = ie(e);
      if (t.initHash) he(e, 'revealed');
      else {e.addEventListener('htmx:afterProcessNode', function () {
          he(e, 'revealed');
        }, { once: true });}
    }
  }
  ...
  function Rt(e) {
    const t = [];
    if (e instanceof DocumentFragment) { for (const n of e.childNodes) Ot(n, t); }
    else Ot(e, t);
    return t;
  }
  function Ht(e) {
    if (e.querySelectorAll) {
      ...
      const o = e.querySelectorAll(
        H + n + ", form, [type='submit']," +
          ' [hx-ext], [data-hx-ext], [hx-trigger], [data-hx-trigger]' + r.flat().map((e) =>
            ', ' + e
          ).join(''),
      );
      return o;
  ...
  function Nt(t, e, n) {
    const r = ie(t);
    if (!Array.isArray(r.onHandlers)) r.onHandlers = [];
    let o;
    const i = function (e) {
      vn(t, function () {
        if (at(t)) return;
  ...
  function Pt(t) {
    ...
    if (n.initHash !== e) {
      ...
      const o = wt(t, n, r);
      if (!o) {
        if (re(t, 'hx-boost') === 'true') ft(t, n, r);
  ...
  function he(e, t, n) {
    ...
    n.elt = e;
    const r = Mt(t, n);
    if (Q.logger && !Xt(t)) Q.logger(e, t, n);
    if (n.error) {
      O(n.error);
  ...
  function Vt(t) {
    ...
    for (let e = 0; e < n.length; e++) if (n[e].url === t) return n[e];
    return null;
  }
  function _t(e) {
  ...
  function Gt(o) {
    ...
    e.onload = function () {
      ...
      } else fe(ne().body, 'htmx:historyCacheMissLoadError', i);
    };
    e.send();
  }
  function Wt(e) {
  ...
  function en(t, n) {
    for (let e = 0; e < t.length; e++) {
      const r = t[e];
      if (r.isSameNode(n)) return true;
    }
    return false;
  }
  function tn(e) {
    const t = e;
    if (t.name === '' || t.name == null || t.disabled || g(t, 'fieldset[disabled]')) return false;
    if (
      t.type === 'button' || t.type === 'submit' || t.tagName === 'image' ||
      t.tagName === 'reset' || t.tagName === 'file'
    ) return false;
  ...
  function rn(t, n, r) {
    if (t != null && n != null) {
      let e = r.getAll(t);
      if (Array.isArray(n)) e = e.filter((e) => n.indexOf(e) < 0);
      else e = e.filter((e) => e !== n);
      r.delete(t);
      se(e, (e) => r.append(t, e));
    }
  }
  function on(t, n, r, o, i) {
    if (o == null || en(t, o)) return;
    else t.push(o);
    if (tn(o)) {
      const s = ee(o, 'name');
      let e = o.value;
    ...
    if (o instanceof HTMLFormElement) {
      se(o.elements, function (e) {
        if (t.indexOf(e) >= 0) rn(e.name, e.value, n);
        else t.push(e);
        if (i) sn(e, r);
      });
      new FormData(o).forEach(function (e, t) {
        if (e instanceof File && e.name === '') return;
        nn(t, e, n);
      });
    }
  }
  ...
  function ln(n, e) {
    for (const t of e.keys()) n.delete(t);
  ...
  function cn(e, t) {
    ...
    const i = [];
    const s = ie(e);
    if (s.lastButtonClicked && !le(s.lastButtonClicked)) s.lastButtonClicked = null;
    let l = e instanceof HTMLFormElement && e.noValidate !== true ||
      te(e, 'hx-validate') === 'true';
    if (s.lastButtonClicked) l = l && s.lastButtonClicked.formNoValidate !== true;
    if (t !== 'get') on(n, o, i, g(e, 'form'), l);
    on(n, r, i, e, l);
    if (
      s.lastButtonClicked || e.tagName === 'BUTTON' ||
  ...
  function gn(e, t) {
    ...
    if (Q.config.scrollIntoViewOnBoost && ie(e).boosted && !dn(e)) r.show = 'top';
    if (n) {
      const s = F(n);
      if (s.length > 0) {
        for (let e = 0; e < s.length; e++) {
          const l = s[e];
          if (l.indexOf('swap:') === 0) r.swapDelay = d(l.slice(5));
          else if (l.indexOf('settle:') === 0) r.settleDelay = d(l.slice(7));
          else if (l.indexOf('transition:') === 0) r.transition = l.slice(11) === 'true';
          else if (l.indexOf('ignoreTitle:') === 0) r.ignoreTitle = l.slice(12) === 'true';
          ...
          } else if (e == 0) r.swapStyle = l;
          else O('Unknown modifier in hx-swap: ' + l);
        }
      }
    }
    return r;
  ...
  function pn(e) {
    return re(e, 'hx-encoding') === 'multipart/form-data' ||
      h(e, 'form') && ee(e, 'enctype') === 'multipart/form-data';
  }
  function mn(t, n, r) {
    let o = null;
    Ft(n, function (e) {
      if (o == null) o = e.encodeParameters(t, r, n);
    });
    if (o != null) return o;
    else {if (pn(n)) return ln(new FormData(), qn(r));
      else return an(r);}
  }
  function xn(e) {
    return { tasks: [], elts: [e] };
  ...
  function yn(e, t) {
    ...
    if (t.scroll) {
      var o = null;
      if (t.scrollTarget) o = ue(ae(n, t.scrollTarget));
      if (t.scroll === 'top' && (n || o)) {
        o = o || n;
        o.scrollTop = 0;
      }
  ...
  function Rn(t, n, r) {
    ...
    } else return de(t, n, null, null, { returnPromise: true });
  }
  function Hn(e) {
    const t = [];
    while (e) {
  ...
  function Ln(r, o, e) {
    return new Proxy(e, {
      get: function (t, e) {
        ...
        if (t[e] && t[e].length === 1) return t[e][0];
        else return t[e];
      },
      set: function (e, t, n) {
        e[t] = n;
  ...
  function An(o) {
    return new Proxy(o, {
      ...
      set: function (t, n, e) {
        ...
        } else if (typeof e === 'object' && !(e instanceof Blob)) t.append(n, JSON.stringify(e));
        else t.append(n, e);
        return true;
      },
      deleteProperty: function (e, t) {
        if (typeof t === 'string') e.delete(t);
        return true;
      },
      ownKeys: function (e) {
  ...
  function de(t, n, r, o, i, D) {
    ...
    if (a) {
      ...
      if (A != null) { if (A.toLowerCase() !== 'dialog') t = A; }
    }
    ...
    if (d) {
      ...
      } else if (d === 'replace') he(h, 'htmx:abort');
    ...
    if (u.xhr) {
      if (u.abortable) he(h, 'htmx:abort');
      else {
        if (g == null) {
          if (o) {
            const P = ie(o);
            if (P && P.triggerSpec && P.triggerSpec.queue) g = P.triggerSpec.queue;
          }
          if (g == null) g = 'last';
        }
    ...
    let y = fn(r, c, x);
    if (t !== 'get' && !pn(r)) y['Content-Type'] = 'application/x-www-form-urlencoded';
    if (i.headers) y = ce(y, i.headers);
    const U = cn(r, t);
    let b = U.errors;
    const j = U.formData;
    if (i.values) ln(j, qn(i.values));
    const V = qn(En(r));
    const v = ln(j, V);
    let w = hn(v, r);
    ...
    p.onload = function () {
      try {
        ...
        M(r, H);
        if (H.keepIndicators !== true) Qt(T, q);
  ...
  function Dn(o, i) {
    ...
    if (R(s, /HX-Trigger:/i)) Je(s, 'HX-Trigger', o);
    ...
    if (R(s, /HX-Retarget:/i)) {
      if (s.getResponseHeader('HX-Retarget') === 'this') i.target = o;
      else i.target = ue(ae(o, s.getResponseHeader('HX-Retarget')));
    }
    const u = Nn(o, i);
    const r = Pn(s);
    const a = r.swap;
    ...
    let d = r.select;
    if (r.target) i.target = ue(ae(o, r.target));
    var g = e.swapOverride;
    if (g == null && r.swapOverride) g = r.swapOverride;
    if (R(s, /HX-Retarget:/i)) {
      if (s.getResponseHeader('HX-Retarget') === 'this') i.target = o;
      else i.target = ue(ae(o, s.getResponseHeader('HX-Retarget')));
    }
    ...
    i.successful = !f;
    if (m.shouldSwap) {
      if (s.status === 286) lt(o);
      Ft(o, function (e) {
        p = e.transformResponse(p, s, o);
      });
      if (u.type) zt();
      var x = gn(o, g);
      if (!x.hasOwnProperty('ignoreTitle')) x.ignoreTitle = h;
      ...
      if (x.hasOwnProperty('transition')) t = x.transition;
      if (
        t && he(o, 'htmx:beforeTransition', i) && typeof Promise !== 'undefined' &&
      ...
      if (x.swapDelay > 0) E().setTimeout(e, x.swapDelay);
      else e();
    }
    if (f) {
      fe(
  ...
  function Vn(e) {
    if (jn || ne().readyState === 'complete') e();
    else ne().addEventListener('DOMContentLoaded', e);
  }
  function _n() {
    if (Q.config.includeIndicatorStyles !== false) {
      ...
      ne().head.insertAdjacentHTML(
        'beforeend',
        '<style' + e + '>      .' + Q.config.indicatorClass + '{opacity:0}      .' +
          Q.config.requestClass + ' .' + Q.config.indicatorClass +
          '{opacity:1; transition: opacity 200ms ease-in;}      .' + Q.config.requestClass + '.' +
